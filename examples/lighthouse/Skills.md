# Skills: Lighthouse Lifestyle Rendering Host

## Purpose

This file provides a capability view for the **lighthouse** rendering host. Use it with the repository skills map to quickly choose the correct implementation pattern for App Router, XM Cloud layout rendering, and editor-safe component work.
